...
values = [86.90, 35.34, 45.45, 77.90]

# MÀU SẮC CHO K-NN TỪ FILE WORD: Xám (Accuracy), Cam Nâu (CM), Hồng (PR), Tím (ROC)
colors = ['#7f8c8d', '#d95f0e', '#e377c2', '#9467bd']
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / 'knn_bar.png', dpi=300, bbox_inches='tight')
print("   [+] Đã xuất file ")
